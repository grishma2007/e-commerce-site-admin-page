...
const Info = ()=>{
   ...
   useEffect(() => {
  axios.get('https://e-commerce-backend-self-five.vercel.app/info', { withCredentials: true })
    .then(res => {
      setdata(res.data);
    })
    .catch(err => {
  ...
  const Delete = (_id)=>{
    ...
    axios.delete(`https://e-commerce-backend-self-five.vercel.app/info/${_id}`,{ withCredentials: true})
      .then((response)=>{ 
...
const handlesave = async () => {
  ...
  try {
    const res = await axios.put(
      `https://e-commerce-backend-self-five.vercel.app/info/${current._id}`,
